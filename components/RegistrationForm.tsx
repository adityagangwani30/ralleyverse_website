...
const inputClass =
  'w-full bg-surface border border-[#2A2A2A] text-primary placeholder:text-muted font-body text-sm px-4 py-3 rounded-md focus:outline-none focus:border-orange transition-colors duration-200'

const selectClass =
  'w-full bg-surface border border-[#2A2A2A] text-primary font-body text-sm px-4 py-3 rounded-md focus:outline-none focus:border-orange transition-colors duration-200 appearance-none cursor-pointer'
        ...
        {submitted ? (
          ...
          <div className="flex flex-col gap-6">
            ...
            <button
              ...
              className="w-full rounded-md bg-orange py-4 font-body text-sm font-bold tracking-wide text-carbon transition-all duration-200 hover:brightness-110"
            >
              {loading ? (
